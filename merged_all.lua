-- MERGED SCRIPT: Semua script digabung dalam satu file
...
-- ===================== danur.lua =====================
-- ...existing code from danur.lua...

-- ===================== danur1.lua =====================
-- ...existing code from danur1.lua...

-- ===================== danur2.lua =====================
-- ...existing code from danur2.lua...

-- ===================== joki.lua =====================
-- ...existing code from joki.lua...

-- ===================== jump.lua =====================
-- ...existing code from jump.lua...

-- ===================== nojump.lua =====================
-- ...existing code from nojump.lua...

-- ===================== samlongfarm.lua =====================
-- ...existing code from samlongfarm.lua...

-- ===================== samlongmini.lua =====================
-- ...existing code from samlongmini.lua...

-- ===================== teleport.lua =====================
-- ...existing code from teleport.lua...

-- ===================== uang.lua =====================
-- ...existing code from uang.lua...
