...
noJumpButton.Position = UDim2.new(0.1, 0, 0.22, 0)
noJumpButton.Size = UDim2.new(0.8, 0, 0.1, 0)
...
teleportButton1.Position = UDim2.new(0.1, 0, 0.34, 0)
teleportButton1.Size = UDim2.new(0.8, 0, 0.1, 0)
teleportButton1.Font = Enum.Font.SourceSans
teleportButton1.Text = "Teleport 1 (Dealership)"
...
teleportButton2.Position = UDim2.new(0.1, 0, 0.46, 0)
teleportButton2.Size = UDim2.new(0.8, 0, 0.1, 0)
...
exitButton.Size = UDim2.new(0.15, 0, 0.1, 0)
...
teleportButton2.MouseButton1Click:Connect(function()
    ...
    statusLabel.Text = "Teleported to location 2"
end)
